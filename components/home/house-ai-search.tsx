...
function HouseAiSearch({
  available = true,
  initialQuery = "",
  unavailableLabel = "cette page",
}: HouseAiSearchProps) {
  ...
  async function submitSearch(event: React.FormEvent<HTMLFormElement>) {
    ...
    if (!available || !queryText || loading) {
      return
    }
            ...
            <div className="flex items-center justify-between gap-4 border-b border-border p-4 sm:p-5">
              <div className="flex min-w-0 items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  >
                    {available ? "Recherche de maison" : "Recherche IA"}
                  </h2>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Les critères de recherche sont en cours de
                          préparation.
                        </p>
                      </div>
                    </div>
              ...
              <div className="space-y-4 p-4 sm:p-5">
                <div className="rounded-lg border border-border bg-muted/60 p-4">
                  ...
                  <p className="mt-2 text-sm leading-6 text-muted-foreground">
                    Cette fonctionnalité n’est pas encore disponible pour{" "}
                    {unavailableLabel}. Elle sera ajoutée séparément pour chaque
                    page.
                  </p>
                </div>
                <Button
